    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>CHI TIẾT BÀI VIẾT</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="index.php">Bảng điều khiển</a></li>
                            <li class="breadcrumb-item active">Chi tiết bài viết</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <div class="mb-4">
                                ...
                                <label for="type">Tên danh mục</label>
                                <input type="text" name="type" value="<?=$row['title'];?>" id="type" class="form-control"
                                    required>
                            </div>
                            <div class="mb-4">
