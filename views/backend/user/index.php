                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a class="btn btn-sm btn-success"
                                    href="index.php?option=user&cat=status&id=<?= $row['id']?>">
                                ...
                                <a class="btn btn-sm btn-success"
                                    href="index.php?option=user&cat=detail&id=<?= $row['id']?>">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a class="btn btn-sm btn-primary"
                                    href="index.php?option=user&cat=edit&id=<?= $row['id']?>">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a class="btn btn-sm btn-danger"
                                    href="index.php?option=user&cat=delete&id=<?= $row['id']?>">
