                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a class="btn btn-sm btn-success"
                                    href="index.php?option=topic&cat=status&id=<?= $row['id']?>">
                                ...
                                <a class="btn btn-sm btn-success"
                                    href="index.php?option=topic&cat=detail&id=<?= $row['id']?>">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a class="btn btn-sm btn-primary"
                                    href="index.php?option=topic&cat=edit&id=<?= $row['id']?>">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a class="btn btn-sm btn-danger"
                                    href="index.php?option=topic&cat=delete&id=<?= $row['id']?>">
