                    ...
                    <div class="row">
                        <div class="col-md-9">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="phone" id="metakey" class="form-control"
                                    required><?=$row['phone'];?></textarea>
                            </div>
                            <div class="mb-4">
                                <label for="address">Địa chỉ</label>
                                <textarea name="address" id="metakey" class="form-control"
                        ...
                        <div class="col-md-3">
                            <div class="col-md-9">
                                <div class="mb-4">
                                    <label for="updated_at">Ngày tạo</label>
                                    <textarea name="updated_at" id="note" class="form-control"
                                        required><?=$row['updated_at'];?></textarea>
                                </div>
                                <div class="mb-4">
                                    </select>
