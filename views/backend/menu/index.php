...
$list_page = Post::where([['status','!=','0'],['type','=','post']])->get();
?>
                                ...
                                <div class="card position">
                                    <div class="card-body">
                                        ...
                                        <select name="position" id="" class="form-control">
                                            ...
                                            <option value="footermenu">Foodter Menu</option>
                                        </select>
                                    </div>
                                </div>
                                <!--end card position-->
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                <input name="THEMCATEGORY" type="submit" value="Thêm Menu"
                                                    class="btn btn-sm btn-success form_control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div id="collapseCustom" class="collapse" aria-labelledby="headingCustom"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="link" class="form_control">
                                            </div>
                                            <div class="mb-3">
