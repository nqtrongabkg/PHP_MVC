                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a class="btn btn-sm btn-success"
                                    href="index.php?option=category&cat=status&id=<?= $row['id']?>">
                                ...
                                <a class="btn btn-sm btn-success"
                                    href="index.php?option=category&cat=detail&id=<?= $row['id']?>">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a class="btn btn-sm btn-primary"
                                    href="index.php?option=category&cat=edit&id=<?= $row['id']?>">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a class="btn btn-sm btn-danger"
                                    href="index.php?option=category&cat=delete&id=<?= $row['id']?>">
